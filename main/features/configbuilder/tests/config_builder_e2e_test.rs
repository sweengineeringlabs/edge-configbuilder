...
use swe_edge_configbuilder::{create_config_builder, ConfigError};
...
fn test_with_name_sets_application_name() {
    let b = ConfigLoaderFactory::ConfigLoaderFactory::create_config_builder().with_name("swe-edge");
...
fn test_build_loader_with_explicit_dir_reads_written_section() {
    ...
    let cfg: Cfg = ConfigLoaderFactory::ConfigLoaderFactory::create_config_builder()
        .with_name("my-svc")
...
fn test_build_loader_loads_message_broker_style_config() {
    ...
    let cfg: MessageBrokerConfig =
        ConfigLoaderFactory::ConfigLoaderFactory::create_config_builder()
...
fn test_build_loader_load_section_returns_parse_error_for_malformed_toml() {
    ...
    let err = ConfigLoaderFactory::ConfigLoaderFactory::create_config_builder()
        .with_config_dir(dir.path())
        .build_loader()
        .unwrap()
