...
pub enum OnError {
    ...
    ///
    /// [`FeatureRecord::override_source`]: crate::api::loader::vo::feature_record::FeatureRecord::override_source
    /// [`OverrideSource::ValidationError`]: crate::api::loader::vo::override_source::OverrideSource::ValidationError
    Disable,
}
