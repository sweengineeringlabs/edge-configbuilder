...
/// ```
///
/// [`ConfigBuilderImpl`]: crate::api::configbuilder::types::ConfigBuilderImpl
/// [`SubstitutionConfigBuilderImpl`]: crate::api::configbuilder::types::substitution_config_builder_impl::SubstitutionConfigBuilderImpl
